...
export default function Register() {
    ...
    return(
        <View style={{ flex: 1, flexDirection: "column", justifyContent: "flex-start", alignItems: "center", backgroundColor: "white" }}>
            <Text style={[font, { fontSize: 24, color: "#004F3B", marginTop: 70, marginHorizontal: 10 }]}>Welcome to App</Text>
            ...
            <Pressable onPress={handleSubmit} style={{marginTop: 15, marginBottom:50, backgroundColor: '#A4F4CF',  paddingVertical: 10, paddingHorizontal: 10, borderRadius: 15, width: 250}}>
